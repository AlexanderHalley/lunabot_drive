...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # ── 4. OAK-D S2 camera ───────────────────────────────────────────────
        #    Pointcloud config also publishes RGB (needed by apriltag_ros).
        #    If your pointcloud config omits RGB, switch to oak_d_camera.yaml.
        IncludeLaunchDescription(
        ...
        Node(
            ...
            parameters=[{
                ...
                'dump_wait_s':           3.0,
                'lift_actuator_ns':  '/bucket/lift/actuator_driver',
                'tilt_actuator_ns':  '/bucket/tilt/actuator_driver',
            }],
            output='screen',
        ),
